/* TURNIKCOACH_HOTFIX 5.16.1-course-ui-fix */
(function(){
  'use strict';
  const VERSION='5.16.1-course-ui-fix';
  const LABEL='5.16.1';
  ...
  function showUpdatePrompt(activate){
    ...
    text.innerHTML='Исправлена прокрутка длинных окон курса. Дополнительные упражнения TurnikCoach теперь свернуты в компактный блок и раскрываются маленьким треугольником.<br><br>Установить обновление сейчас?';
