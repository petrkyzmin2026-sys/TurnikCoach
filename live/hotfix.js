/* TURNIKCOACH_HOTFIX 5.16.9-progress-control */
(function(){
  'use strict';
  const VERSION='5.16.9-progress-control';
  const LABEL='5.16.9';
  ...
  function showUpdatePrompt(activate){
    ...
    text.innerHTML='Добавлен контроль прогресса в курсе: цель 25/30 или своя, интервал проверки 2–4 недели, отдельное испытание MAX после восстановления, подтверждение результата, пересчёт рабочего плана и история контрольных результатов. При достижении цели приложение предлагает выбор дальнейшего направления, но не переводит на другой уровень автоматически. Дни и состав авторских комплексов не изменяются.<br><br>Установить обновление сейчас?';
