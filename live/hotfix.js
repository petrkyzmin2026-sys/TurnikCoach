/* TURNIKCOACH_HOTFIX 5.16.5-plan-only */
(function(){
  'use strict';
  const VERSION='5.16.5-plan-only';
  const LABEL='5.16.5';
  ...
  function showUpdatePrompt(activate){
    ...
    text.innerHTML='На рабочем экране курса теперь показывается только сам план без пояснений расчёта. Например: «3 × 16». Проценты и расчёт от максимума перенесены в кнопку ⓘ.<br><br>Установить обновление сейчас?';
