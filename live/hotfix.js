/* TURNIKCOACH_HOTFIX 5.16.8-advice-audit */
(function(){
  'use strict';
  const VERSION='5.16.8-advice-audit';
  const LABEL='5.16.8';
  ...
  function showUpdatePrompt(activate){
    ...
    text.innerHTML='Первый этап переработки курса: в «ⓘ Советы автора» добавлены частота тренировок и интервалы отдыха с указанием страниц PDF. Удалены дублирующие кнопки просмотра полной программы из экрана «Сегодня» и служебная аннотация из основного плана. Нормы питания и сна не приписываются автору, поскольку в данном PDF они не указаны.<br><br>Установить обновление сейчас?';
