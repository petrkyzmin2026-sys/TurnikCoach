/* TURNIKCOACH_HOTFIX 5.16.11-all-levels */
(function(){
  'use strict';
  const VERSION='5.16.11-all-levels';
  const LABEL='5.16.11';
  ...
  function showUpdatePrompt(activate){
    ...
    text.innerHTML='Недельное расписание распространено на все 7 уровней курса. Добавлены отдельные контрольные нормативы уровней 1–5 с записью результатов и переходом на следующий уровень только после вашего подтверждения. При цели увеличить количество подтягиваний сохраняется отдельный контроль максимума, без автоматического перехода на силовую специализацию. На седьмом уровне перед тренировкой требуется выбрать два вспомогательных упражнения из указанных автором комплексов. История испытаний объединена; отмена настроек больше не сохраняет выбранный уровень.<br><br>Установить обновление сейчас?';
