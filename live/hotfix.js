/* TURNIKCOACH_HOTFIX 5.16.4-compact-plan */
(function(){
  'use strict';
  const VERSION='5.16.4-compact-plan';
  const LABEL='5.16.4';
  ...
  function showUpdatePrompt(activate){
    ...
    text.innerHTML='Исправлен экран тренировки курса: план больше не повторяет длинную строку «16 · 80% от 21» для каждого подхода. Теперь он показывается компактно: например «3 × 16» и отдельной строкой «80% от максимума 21».<br><br>Установить обновление сейчас?';
