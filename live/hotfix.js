/* TURNIKCOACH_HOTFIX 5.16.6-sequence-plan */
(function(){
  'use strict';
  const VERSION='5.16.6-sequence-plan';
  const LABEL='5.16.6';
  ...
  function showUpdatePrompt(activate){
    ...
    text.innerHTML='План курса теперь показывается по подходам, а не как «3 × 16»: например «16  16  16». Такой же формат применён на экране «Сегодня». Проценты и расчёты остаются только в ⓘ.<br><br>Установить обновление сейчас?';
