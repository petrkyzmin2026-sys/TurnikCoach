/* TURNIKCOACH_HOTFIX 5.16.10-weekly-schedule */
(function(){
  'use strict';
  const VERSION='5.16.10-weekly-schedule';
  const LABEL='5.16.10';
  ...
  function showUpdatePrompt(activate){
    ...
    text.innerHTML='Для 4-го уровня и цели увеличения количества добавлен недельный календарь. По умолчанию: ПН, СР, СБ — курс; остальные дни — дополнительные упражнения или отдых. В настройках можно выбрать 4 занятия по примеру PDF: ПН, СР, ПТ, ВС. Контрольный максимум назначается отдельным заданием после восстановления, без дублирования основного комплекса в этот день. Пропущенная тренировка не считается выполненной и остаётся следующей в последовательности.<br><br>Установить обновление сейчас?';
