/* TURNIKCOACH_HOTFIX 5.16.12-auxiliary-calibration */
(function(){
  'use strict';
  const VERSION='5.16.12-auxiliary-calibration';
  const LABEL='5.16.12';
  ...
  function showUpdatePrompt(activate){
    ...
    text.innerHTML='Добавлены вспомогательные комплексы №2 третьего и шестого уровней как отдельная работа без замены основной тренировки. Включение добровольное: для третьего уровня доступен интервал 7 или 10 дней, для шестого — 10 дней. Проценты у плиометрических, асимметричных, широких и трёхстадийных подтягиваний рассчитываются только после ввода соответствующих максимумов, не по максимуму обычных подтягиваний. Контрольные результаты и история основной программы сохраняются отдельно. Добавлена пятидневная пауза после 30 дней дополнительной ежедневной работы. Повторное завершение сеанса не должно создавать запись-дубль.<br><br>Установить обновление сейчас?';
